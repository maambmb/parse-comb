import unittest
from parsecomb.prim import FailParser, VoidParser, AnyParser, EOSParser, PeekParser, TryParser, CharParser, FirstParser, AllParser, ManyParser, ManyOneParser, ManyOneUntilParser, ManyUntilParser, SepByOneParser, SepByParser
from parsecomb.objs import StrInput
from parsecomb.prac import WordParser, CharSetParser, WordSetParser, WhiteSpaceParser, WhiteSpacesParser, AlphaParser, AlnumParser, DigitParser, IntParser, IdentParser, WrapParser, PadParser
...
class TestParser(unittest.TestCase):
    ...
    def test_wrap(self):
        parser = WrapParser( WrapParser.thick_parens, AllParser( WhiteSpacesParser(), IdentParser(), WhiteSpacesParser() ) )
